package com.rafaelsantos.uri2609.repositories;
...
import com.rafaelsantos.uri2609.dto.CategorySumDTO;
import com.rafaelsantos.uri2609.entities.Category;
...
public interface CategoryRepository extends JpaRepository<Category, Long>{
	...
	@Query("SELECT new com.rafaelsantos.uri2609.dto.CategorySumDTO(obj.category.name, SUM(obj.amount)) "
			+ "FROM Product obj "
